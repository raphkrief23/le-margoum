...
const schedule = [
  { day: "Lundi", hours: "12h00 – 17h00" },
  { day: "Mardi", hours: "12h00 – 17h00" },
  { day: "Mercredi", hours: "12h00 – 17h00" },
  { day: "Jeudi", hours: "12h00 – 17h00" },
  { day: "Vendredi", hours: "12h00 – 17h00" },
  { day: "Samedi", hours: "Fermé" },
  { day: "Dimanche", hours: "12h00 – 17h00" },
];

const MAPS_EMBED_URL =
  "https://maps.google.com/maps?q=43.659818099999995,6.9233663&z=17&output=embed";
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          >
            ...
            <div>
              ...
              <a
                href="mailto:contact@28-pl-aux-aires.fr"
                className="text-primary font-body tracking-wide hover:text-terracotta hover:tracking-wider transition-all duration-300"
              >
                contact@28-pl-aux-aires.fr
              </a>
            </div>
          </div>
          <div
